...
import { agentTaskRoutes } from "./routes/agent-task";
...
fastify.register(marketplaceRoutes); // Marketplace search & compare
fastify.register(agentTaskRoutes); // Agent task execution
